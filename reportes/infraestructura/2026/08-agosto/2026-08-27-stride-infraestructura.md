...
*Reporte **#15** del índice · tipo `infraestructura` · [índice de reportes](../../../README.md)*

> ⚠ **Mismo evento que [`2026-08-27-stride-validacion.md`](2026-08-27-stride-validacion.md)**, escrito
> desde el otro lado: mismas 9 instancias, mismos 0,0383 $, mismos 37,1 min, mismas tres corridas.
> Se escribieron a la vez en dos repos y hasta la centralización del 2026-08-29 nadie podía verlo.
> **El canónico es éste** (es el que tiene `#` en el índice); el otro conserva el detalle del arnés.
> **No se han fusionado a propósito**: fundir dos textos es perder el encuadre de uno de los dos.
