...
cruzan con lo que la [reparametrización de la geometría](https://github.com/stalinbeltran/foveal-vision/blob/main/instructionsNewNN.md) dejó
...
([instructionsNewNN.md §2.2](https://github.com/stalinbeltran/foveal-vision/blob/main/instructionsNewNN.md)) advertía que sobre imágenes de 60×80
...
3. ⚠ **Nada de esto se ha llevado a la métrica de tarea.** Todo son f1 de **ventana**, que es el
   ...
   [ya exageró una vez](https://github.com/stalinbeltran/foveal-vision/blob/main/docs/metrica-de-tarea.md) por un factor de dos en `n_layers`.
