...
| 18 | Los **pesos** de un entrenamiento sobreviven a la máquina | [infraestructura/2026/08-agosto/2026-08-31-pesos-sobreviven-a-la-maquina.md](infraestructura/2026/08-agosto/2026-08-31-pesos-sobreviven-a-la-maquina.md) | 2026-08-31 00:10:47 | 2026-08-31 00:24:41 | **5** *(1 entrenó)* | **0,0295 $** | **Pasa por los dos caminos**: `best.pt` y `last.pt` llegan de Vast y del dev a git, y cargan desde un clon limpio. Había **tres** puertas cerradas y ninguna daba error. ⚠ En el dev el commit sigue siendo manual: aquí se salvaron **por accidente**, porque el libro de a bordo de la flota hace `git add -A` |
| 19 | El **canal de relleno**: decirle a la red qué píxeles se ha inventado | [estudios/2026/09-septiembre/2026-09-01-canal-de-relleno.md](estudios/2026/09-septiembre/2026-09-01-canal-de-relleno.md) | 2026-09-01 02:10:02 | 2026-09-01 02:57:27 | **1** *(1 entrenó)* | **0,0386 $** | El agujero del borde **se cierra entero**: recall del último píxel 0,608 → **0,974**, y de propina el f1 sube a 0,9543 y el err_px baja un 13,6 %. ⚠ **Una semilla: como resultado de f1 no cuenta** (+0,0068 < δ). Lo que no es ruido es el borde: +0,366 en un tramo, ~70× el ruido entre semillas. ⚠ `edge_inputs` solo cerraba **menos de 1/5** del hueco |
| 20 | `do-v` — `dropout` completo: 5 semillas y un `p` de verdad | [estudios/2026/09-septiembre/2026-09-02-dropout-completo.md](estudios/2026/09-septiembre/2026-09-02-dropout-completo.md) | 2026-09-01 21:43:55 | 2026-09-02 01:57:10 | **23** *(11 entrenaron)* | **1,8656 $** *(la flota entera, con el #21; ~1,011 $ derivados)* | El vigente `0,0` se queda **con capacidad de declarar**: ningún valor llega a `p` < 0,05 (el más bajo, 0,151). Y el punto nuevo `0,05` —la única razón de coste del estudio— resulta ser **el peor de los cuatro** |
| 21 | `sc-t`/`sp-t`/`sd-t` — los strides de rama: encoger la cabeza | [estudios/2026/09-septiembre/2026-09-02-strides-rama-tanteo.md](estudios/2026/09-septiembre/2026-09-02-strides-rama-tanteo.md) | 2026-09-01 21:43:55 | 2026-09-02 01:57:10 | **23** *(11 entrenaron)* | **1,8656 $** *(la flota entera, con el #20; ~0,779 $ derivados)* | El **diagonal `s`=2** da el mejor f1 de los 24 runs (0,9358 vs 0,9315) con el **31,7 % de los parámetros** y 0,72× el reloj. ⚠ Tanteo de 2 semillas: **no declara**. Y a `s`=4 hay **interacción negativa** entre ramas (pierde el doble que la suma) |
| 22 | `sonda-l1` — tanteo del eje `k`: ¿aprende filtros genéricos L1 si SÍ hay presión? | [estudios/2026/09-septiembre/2026-09-03-sonda-l1-tanteo-eje-k.md](estudios/2026/09-septiembre/2026-09-03-sonda-l1-tanteo-eje-k.md) | 2026-09-03 02:33:54 | 2026-09-03 04:40:13 | **0** *(droplet dev, 2 vCPU)* | **0 $** *(el coste es reloj: 2,1 h)* | **NO.** Con código disperso y sano los kernels salen localizados y **no orientados**; sin esparsidad el modelo coge el atajo de la **identidad** (kernels delta, σ 0,49 px contra 1,41 de uno aleatorio, R² rec = 1,000). ⚠ El ajuste a Gabor —la métrica principal del encargo— **supera su nulo en las 8** configuraciones y habría dicho «éxito» sobre esos deltas: lo desmienten las métricas espectrales sin plantilla. 1 semilla: acota, **no declara** |
| 23 | `soft-argmax` — leer las coordenadas como esperanza en vez de regresarlas | [estudios/2026/09-septiembre/2026-09-05-soft-argmax-cabeza.md](estudios/2026/09-septiembre/2026-09-05-soft-argmax-cabeza.md) | 2026-09-04 23:39 | 2026-09-05 04:07 | **0** *(droplet dev, 2 vCPU)* | **0 $** *(el coste es reloj: 4,5 h)* | **`pos_err_px` 2,224 → 0,571 px (3,9×)** sobre la plana `4k7`, y **no es la pila conv**: el control C —misma pila, 1,66× la cabeza, lectura `Linear`— se queda en 1,414. Se descompone en −0,810 (la pila) y −0,843 (la lectura), y **se componen**. ⚠ El **control de f1 falló** (subió en los tres brazos, también en C): la posición sigue siendo comparable porque se promedia sobre las **mismas** 14.724 esquinas de `exists_true`, pero no se puede afirmar que `exists` quede intacto. ⚠ El sesgo de contracción **existe y está medido** (borde/interior 1,57× → 2,05×) y lo **tapa** la ganancia. ⚠⚠ El precio no es de parámetros (+0,2 %) sino de **cómputo: ×266 MACs de cabeza**. 1 semilla: acota, **no declara** |

**Gastado y registrado hasta aquí: ≥25,38 $** (13,33 hasta el #13, más ≥9,94 del #14, más 0,04 de
la validación del #15, 1,68 del barrido de stride del #16, 0,36 del tanteo de dropout del #17 y
0,03 de la verificación de los pesos del #18).
