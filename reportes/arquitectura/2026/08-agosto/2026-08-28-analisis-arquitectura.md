...
[`reportes/README.md`](../../../README.md).** Aquella tabla lleva instancias y coste real porque existe
...
vez de una decepción — visible en el tanteo de `dropout` ([#17](../../../estudios/2026/08-agosto/2026-08-28-dropout-tanteo.md)),
...
> [`docs/reglas-de-diseno.md`](https://github.com/stalinbeltran/telegram-coordinator/blob/main/docs/reglas-de-diseno.md). Este reporte es **la evidencia**;
